...
from app.metrics_dashboard_pro import HTML as metrics_dashboard_html
from app.metrics_dashboard_pro import app as metrics_dashboard_app
...
# Dashboard de métricas adjunto. Se monta antes del catch-all SPA para
# que /metricas y /metricas/api/* no sean absorbidos por React.
