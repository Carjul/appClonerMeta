...
FB_CATALOG_TRICK_RUNNER_ENABLED = _as_bool(os.getenv("FB_CATALOG_TRICK_RUNNER_ENABLED"), True)
FB_CATALOG_TRICK_RUNNER_INTERVAL_SECONDS = int(os.getenv("FB_CATALOG_TRICK_RUNNER_INTERVAL_SECONDS", "3600"))
FB_CATALOG_PLANNING_RUNNER_ENABLED = _as_bool(os.getenv("FB_CATALOG_PLANNING_RUNNER_ENABLED"), True)
FB_CATALOG_PLANNING_RUNNER_INTERVAL_SECONDS = int(os.getenv("FB_CATALOG_PLANNING_RUNNER_INTERVAL_SECONDS", "60"))
